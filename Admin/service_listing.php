...
if (!empty($_SESSION['current_user'])) {
    ...
    $totalRecords = mysqli_query($con, "SELECT * FROM `service`");
    $totalRecords = $totalRecords->num_rows;
    $totalPages = ceil($totalRecords / $item_per_page);
    $products = mysqli_query($con, "SELECT * FROM `service` ORDER BY `id` DESC LIMIT " . $item_per_page . " OFFSET " . $offset);
    mysqli_close($con);
    ?>
    <div class="main-content">
        ...
        <div class="product-items">
            <div class="buttons">
                <a href="./product_editing.php">Add service</a>
            </div>
            <ul>
                <li class="product-item-heading" style="background: #717171;">
