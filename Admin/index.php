...
<body style="margin-top: 100px; background-image: url(https://i.pinimg.com/originals/e1/a9/f3/e1a9f39bfa46192b65083d4b1d1874e3.jpg);
...
<?php
        ...
        <?php if (empty($_SESSION['current_user'])) { ?>
            ...
            ?>
            <div id="login-notify" class="box-content" style="color:white; font-size: 17px;">
                Xin chào: <?= $currentUser['fullname'] ?><br/>
            </br>
                <form method="get" action="./product_listing.php">
                    <button type="submit">Quản lý phòng</button>
                </form><br/>
